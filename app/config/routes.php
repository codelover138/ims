...
$route['admin/gamma/open_form/(:num)'] = 'admin/gamma/open_form/$1';
$route['admin/gamma/submit_form/(:num)'] = 'admin/gamma/submit_form/$1';
$route['admin/gamma/download/(:num)'] = 'admin/gamma/download/$1';
$route['admin/gamma_forms'] = 'admin/gamma_forms';
$route['admin/gamma_forms/import_forms_csv'] = 'admin/gamma_forms/import_forms_csv';
$route['admin/gamma_forms/import_inputs_csv'] = 'admin/gamma_forms/import_inputs_csv';
$route['admin/gamma_forms/generate_input_form/(:num)'] = 'admin/gamma_forms/generate_input_form/$1';
$route['admin/gamma_forms/delete_form/(:num)'] = 'admin/gamma_forms/delete_form/$1';
$route['admin/gamma/delete_document/(:num)'] = 'admin/gamma/delete_document/$1';
$route['admin/gamma/file_manager'] = 'admin/gamma/file_manager';
$route['admin/document/gamma_elfinder_init'] = 'admin/document/gamma_elfinder_init';
...
$route['admin/forgot-username'] = 'admin/auth/forgot_username';
$route['admin/forgot_username'] = 'admin/auth/forgot_username';
