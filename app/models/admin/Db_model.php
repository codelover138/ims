...
class Db_model extends CI_Model
{
    ...
    public function getLatestSales()
    {
       ...
       // if ($this->session->userdata('view_right') === '0' && !$this->Owner && !$this->Admin) {
       //     $this->db->where('created_by', $this->session->userdata('user_id'));
       // }
         if ($this->session->userdata('view_right') === '2' && !$this->Owner && !$this->Admin) {
             $this->db->where('service_provider', $this->session->userdata('user_id'))->or_where('created_by', $this->session->userdata('user_id'));
         }
