<div class="gamma-generated-form"><form method="post" action="http://localhost/ims/admin/gamma/submit_form/7"><div class="gamma-generated-header"><h3>Registration Form</h3></div><div class="row"><div class="col-md-12"><div class="form-group gamma-generated-field"><label>Name</label><input type="text" name="name" value="" class="form-control"></div></div></div><div class="row"><div class="col-md-12"><div class="form-group gamma-generated-field"><label>Age</label><input type="text" name="age" value="" class="form-control"></div></div></div><div class="row"><div class="col-md-12"><div class="form-group gamma-generated-field"><label>Sex</label><select name="sex" class="form-control"><option value="Male">Male</option><option value="Female">Female</option></select></div></div></div><div class="row"><div class="col-md-12"><div class="form-group gamma-generated-field"><label>Availablity</label><div class="checkbox"><label><input type="checkbox" name="availablity" value="1"> Availablity</label></div></div></div></div><div class="form-group"><button type="submit" class="btn btn-primary">Submit</button></div></form></div><script>
