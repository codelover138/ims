<div class="gamma-generated-form"><form method="post" action="http://localhost/ims/admin/gamma/submit_form/10"><div class="gamma-generated-header"><h3>TEST</h3></div><div class="row"><div class="col-md-12"><div class="form-group gamma-generated-field"><label>Title</label><input type="text" name="title" value="" class="form-control"></div></div></div><div class="form-group"><button type="submit" class="btn btn-primary">Submit</button></div></form></div><script>
